...
// Ensure App.css is imported in App.js, so these styles load
...
const Leaderboard = ({ results, darkMode, taskId }) => {
  ...
  // --- HEADER WITH IMPROVED ACTIVE STATE ---
  ...
  return (
    <div className="animate__animated animate__fadeIn mt-5">
      ...
      {/* DETAIL CARD (Kept mostly the same but with glass classes) */}
      {bestModel && (
